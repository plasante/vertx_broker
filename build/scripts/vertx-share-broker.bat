...
set CLASSPATH=%APP_HOME%\lib\vertx-share-broker-1.0.0-SNAPSHOT.jar;%APP_HOME%\lib\vertx-web-4.5.9.jar;%APP_HOME%\lib\log4j-slf4j18-impl-2.17.1.jar;%APP_HOME%\lib\slf4j-api-2.0.7.jar;%APP_HOME%\lib\log4j-core-2.17.1.jar;%APP_HOME%\lib\log4j-api-2.17.1.jar;%APP_HOME%\lib\jackson-annotations-2.16.1.jar;%APP_HOME%\lib\vertx-web-client-4.5.9.jar;%APP_HOME%\lib\vertx-pg-client-4.5.9.jar;%APP_HOME%\lib\vertx-mysql-client-4.5.9.jar;%APP_HOME%\lib\vertx-web-common-4.5.9.jar;%APP_HOME%\lib\vertx-auth-common-4.5.9.jar;%APP_HOME%\lib\vertx-bridge-common-4.5.9.jar;%APP_HOME%\lib\vertx-uri-template-4.5.9.jar;%APP_HOME%\lib\vertx-sql-client-templates-4.5.9.jar;%APP_HOME%\lib\vertx-sql-client-4.5.9.jar;%APP_HOME%\lib\vertx-core-4.5.9.jar;%APP_HOME%\lib\jackson-core-2.16.1.jar;%APP_HOME%\lib\jackson-databind-2.16.1.jar;%APP_HOME%\lib\flyway-mysql-8.5.4.jar;%APP_HOME%\lib\flyway-core-8.5.4.jar;%APP_HOME%\lib\mysql-connector-java-8.0.28.jar;%APP_HOME%\lib\postgresql-42.3.1.jar;%APP_HOME%\lib\netty-handler-proxy-4.1.111.Final.jar;%APP_HOME%\lib\netty-codec-http2-4.1.111.Final.jar;%APP_HOME%\lib\netty-codec-http-4.1.111.Final.jar;%APP_HOME%\lib\netty-resolver-dns-4.1.111.Final.jar;%APP_HOME%\lib\netty-handler-4.1.111.Final.jar;%APP_HOME%\lib\netty-transport-native-unix-common-4.1.111.Final.jar;%APP_HOME%\lib\netty-codec-socks-4.1.111.Final.jar;%APP_HOME%\lib\netty-codec-dns-4.1.111.Final.jar;%APP_HOME%\lib\netty-codec-4.1.111.Final.jar;%APP_HOME%\lib\netty-transport-4.1.111.Final.jar;%APP_HOME%\lib\netty-buffer-4.1.111.Final.jar;%APP_HOME%\lib\netty-resolver-4.1.111.Final.jar;%APP_HOME%\lib\netty-common-4.1.111.Final.jar;%APP_HOME%\lib\protobuf-java-3.11.4.jar;%APP_HOME%\lib\checker-qual-3.5.0.jar
