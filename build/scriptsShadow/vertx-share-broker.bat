...
set CLASSPATH=%APP_HOME%\lib\vertx-share-broker-1.0.0-SNAPSHOT-fat.jar

@rem Execute vertx-share-broker
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %VERTX_SHARE_BROKER_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%VERTX_SHARE_BROKER_EXIT_CONSOLE%" exit 1
exit /b 1
